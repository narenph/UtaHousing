...
public class DeleteApartment extends Activity{
    ...
    public void addListenerOnButton() {
        ...
        delButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(DeleteApartment.this,
                        "OnClickListener : " +
                ...
                enter.execute(String.valueOf(spinner1.getSelectedItem()), String.valueOf(spinner2.getSelectedItem()));
                System.out.print("in");
                Toast.makeText(
                        DeleteApartment.this,
                        "Apartment Delted Succesfully", Toast.LENGTH_SHORT)
                        .show();


                Intent i = new Intent(DeleteApartment.this, AdminOptionPage.class);
                startActivity(i);
                finish();
            }
    ...
    private class EnterValues extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                String toPostPHP = "aptname=" + aptname + "&apttype=" + apttype;
                System.out.println(toPostPHP);

                String fullURL = "http://omega.uta.edu/~gxr7481/delete_apartment.php?" + toPostPHP;
...
//
    ...
    private void spinner_fn()
    {
        ...
        ArrayAdapter<String> dataAdapter1 = new ArrayAdapter<String>(DeleteApartment.this,android.R.layout.simple_spinner_item, aptname);
